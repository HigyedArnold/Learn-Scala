package com.aibuild.allaboutscala.akka.dispatchers
...
import com.aibuild.allaboutscala.akka.dispatchers.Dispatchers.DonutStoreProtocol.{DonutStockRequest, StockRequest}
...
object Dispatchers extends App {
  ...
  implicit val executionContext: MessageDispatcher = system1.dispatchers.lookup("resizable-thread-pool")
  ...
  class DonutStockRequestActor extends Actor with ActorLogging {
    val randomStock: Random.type = scala.util.Random
