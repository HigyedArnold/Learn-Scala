...
//  case class Donut(name: String, price: Double, productCode: Option[Long] = None)
  ...
  calculateTotal2(Seq(ShoppingCartItem(vanillaDonut, 10), ShoppingCartItem(chocolateVanillaDonut, 15)))
...
//  import DonutImplicits._
  ...
  println("\nStep 6: How to create new LocalDateTime instance using LocalDateTime alias from package object")
