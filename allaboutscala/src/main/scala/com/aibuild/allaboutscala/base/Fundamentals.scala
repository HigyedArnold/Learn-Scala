...
import com.aibuild
import com.aibuild.allaboutscala
import com.aibuild.allaboutscala.base
...
object Fundamentals extends App {
  ...
  object Donut extends Enumeration {
    ...
    val Glazed:     base.Fundamentals.Donut.Value                                  = Value("Glazed")
    val Strawberry: allaboutscala.base.Fundamentals.Donut.Value                    = Value("Strawberry")
    val Plain:      aibuild.allaboutscala.base.Fundamentals.Donut.Value            = Value("Plain")
    val Vanilla:    _root_.com.aibuild.allaboutscala.base.Fundamentals.Donut.Value = Value("Vanilla")
  }
  ...
  object DonutTaste extends Enumeration {
    ...
    val Tasty:     Fundamentals.DonutTaste.Value = Value(0,  "Tasty")
    val VeryTasty: Fundamentals.DonutTaste.Value = Value(1,  "Very Tasty")
    val Ok:        Fundamentals.DonutTaste.Value = Value(-1, "Ok")
  }
