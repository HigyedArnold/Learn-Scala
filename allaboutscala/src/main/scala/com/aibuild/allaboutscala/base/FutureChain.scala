...
import scala.language.postfixOps //This provides the "1 second" syntax
...
object FutureChain extends App {
  ...
  val fFilter:       Future[FilteredCoffee] = fCombine.flatMap(unfilteredCoffee => filter(unfilteredCoffee))
