...
//  donutShoppingCartm.checkStockQuantity("Vanilla Donut")
  ...
  trait MockedDonutStoreServices extends DonutStoreServices {
    ...
    override val donutShoppingCartService: DonutShoppingCartService[String] = new DonutShoppingCartService[String](donutInventoryService, donutPricingService, donutOrderService)
  }
