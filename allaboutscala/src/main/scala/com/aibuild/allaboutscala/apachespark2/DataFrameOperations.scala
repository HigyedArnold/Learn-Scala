...
object DataFrameOperations extends App with Context {
  ...
  val dfTags = sparkSession.read
    ...
    .csv("allaboutscala/src/main/resources/question_tags_10K.csv")
    .toDF("id", "tag")

  dfTags.show(10)

  //noinspection NameBooleanParameters
  val dfQuestionsCSV = sparkSession.read
    .option("header", false)
    .option("inferSchema", true)
    .option("dateFormat", "yyyy-MM-dd HH:mm:ss")
    .csv("allaboutscala/src/main/resources/questions_10K.csv")
  ...
  val tagsDF = sparkSession.read
    ...
    .option("inferSchema", true)
    .json("allaboutscala/src/main/resources/tags_sample.json")
  ...
  //noinspection NameBooleanParameters
  val tagsDFss = sparkSession.read
    .option("multiLine", true)
    .option("inferSchema", true)
    .json("allaboutscala/src/main/resources/tags_sample.json")
