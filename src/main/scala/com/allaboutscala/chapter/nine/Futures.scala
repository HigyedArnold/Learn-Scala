...
object Futures extends App {
  ...
  val futureFoldLeft = Future.foldLeft(futureOperations2)(0){ case (acc, someQty) =>
  ...
  val futureFoldLeft2 = Future.reduceLeft(futureOperations2){ case (acc, someQty) =>
