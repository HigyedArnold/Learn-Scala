...
object MutableCollection extends App {
  ...
  val emptyMap1: HashMap[String,String] = HashMap.empty[String,String]
  ...
  val treeSet3: TreeSet[String] = TreeSet("Plain Donut", "Strawberry Donut", "Chocolate Donut")(DescendingAlphabetOrdering1)
